...
function App() {
  ...
  return (
    <div className="px-4 md:px-36 py-4 bg-[#d6dbe1] overflow-x-auto">
      <ParticulesBackground />
      <div className="flex flex-col md:flex-row">
      <div className="rounded-t-3xl bg-white md:bg-none md:rounded-bl-3xl text-[#172330] flex-col items-center justify-center md:mt-20 z-10">
        <Sidebar />
      </div>
