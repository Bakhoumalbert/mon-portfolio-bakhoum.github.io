...
export const Contact = () => {
  ...
  return (
    <div className="w-full h-full sm:text-sm md:text-sm text-sm space-y-6 p-4">
      <div className="relative left-0 flex flex-col py-2 space-y-6">
        <h1 className="text-3xl font-ttl">Formulaire de Contact</h1>
        <UnderlineTitle />
      </div>
      <div>
        <form className="flex flex-wrap gap-8 justify-between p-2">
          <div className="w-full md:w-[325px] h-16 bg-[#F5F8F9] flex flex-row rounded-2xl border justify-between items-center py-3 px-4">
