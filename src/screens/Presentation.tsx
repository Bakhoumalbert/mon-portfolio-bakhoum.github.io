...
export const Presentation = () => {
  ...
  return (
    <div className="p-4 sm:text-sm md:text-base lg:text-xl">
      ...
      <p className="pl-20 flex flex-row space-x-2">
      ...
      <p className="pl-20 flex flex-col">
      ...
      <p className="pl-20 flex flex-row space-x-4">
